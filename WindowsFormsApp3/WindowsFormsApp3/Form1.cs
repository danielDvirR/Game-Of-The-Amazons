...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        public Form1(int[,] board, int boardSize)
        {
            ...
            whiteQueenIcon = new Bitmap(new Bitmap(@"C:\C-board\whiteQueen.png"), new Size(tileSize - 1, tileSize - 1));
            blackQueenIcon = new Bitmap(new Bitmap(@"C:\C-board\blackQueen.png"), new Size(tileSize - 1, tileSize - 1));
            arrowIcon = new Bitmap(new Bitmap(@"C:\C-board\Arrow.png"), new Size(tileSize - 1, tileSize - 1));
            currentPlayer = 2;
            stage = 0;
            prevButton = null;
        }
